      ...
      <Container>
        <Flex>
          <Right>
            ...
            <p>
              ...
              meet their criteria. Parents can input their preferences on the
              platform such as budget, location and many more{" "}
            </p>
            <div>
              <FaSearch /> What will you like to know{" "}
        ...
        <Grid>
          ...
          <Card>
            ...
            <p>
              The platform helps in conducting proper research for you in
              finding the appropriate school for your kids
            </p>
          </Card>
          <Card>
        ...
        <WhatContainer>
          ...
          <Flex>
            <Comments>
              ...
              <h5>
                School4u has helped me save maximum time by providing the best
            ...
            <Comments2>
              <CommentImage src="assets/rename.png" alt="quote" />
              <h5>
                School4u is one of the most innovative and helpful website I
                have come across in recent days
              </h5>
            </Comments2>
            <Comments>
              <CommentImage src="assets/rename.png" alt="quote" />
              <h5>
                School4u has changed my life. Now I dont have to worry about
